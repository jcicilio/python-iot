...
# modify depending on if running at command line or if systemd then full path is required
path = "/home/pi/s/sounds/"
...
if __name__ == "__main__":
    print "soundmaker started"
    print "setting audio levels"
    os.system("amixer scontrols")
